...
const Layout = ({ children }) => {
    ...
    return (
        <div className="flex min-h-screen font-sans antialiased relative">
            ...
            <div className={`flex-1 flex flex-col min-h-screen w-full transition-all duration-300 relative ${user ? (isCollapsed ? 'lg:ml-24' : 'lg:ml-72') : ''}`}>
                {isLanding && (
                    <div className="mesh-background">
                        <div className="mesh-spotlight"></div>
                    </div>
                )}
                <Navbar
